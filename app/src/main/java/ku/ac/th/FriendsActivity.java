                ...
                UsersRef.child(userIDs).addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot)
                    {
                        if (dataSnapshot.exists())
                        {
                            ...
                            final String faculty = dataSnapshot.child("faculty").getValue().toString();
                            ...
                            viewHolder.setFaculty(faculty);
                            viewHolder.setMajor(major);
                            ...
                            viewHolder.mView.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v)
                                {
                                    CharSequence options[] = new CharSequence[]
                                            {
                                                    "ดูโปรไฟล์ของ" + " " + userName,
                                                    "ส่งข้อความ"
                                            };
                                    Log.i("optionscharse", String.valueOf(userName));
...
//            Picasso.with(cxt).load(profileimage).placeholder(R.drawable.profile).into(myImagesearch);
        ...
        {
            TextView friendsFaculty = (TextView) mView.findViewById(R.id.all_users_profile_faculty);
            friendsFaculty.setText(faculty);
        }

        public void setMajor(String major)
        {
            TextView friendsMajor = (TextView) mView.findViewById(R.id.all_users_profile_faculty);
            friendsMajor.setText(major);
        }
//        public void setDate(String date)
//        {
//            TextView friendsDate = (TextView) mView.findViewById(R.id.all_users_profile_faculty);
