...
public class CommentsActivity extends AppCompatActivity
{
    ...
    public static class CommentsViewHolder extends RecyclerView.ViewHolder
    {
        ...
        public void setDate(String date)
        {
            ...
            myDate.setText(" วันที่: " + date);
        }
        public void setTime(String time)
        {
            TextView myTime = (TextView) mView.findViewById(R.id.comment_time);
            myTime.setText(" เวลา: " + time);
        }
    ...
    private void ValidateComment(String userName)
    {
        ...
        {
            Toast.makeText(CommentsActivity.this,"กรุณากรอกความคิดเห็น...",Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            PostsRef.child(RandomKey).updateChildren(commentsMap)
                    .addOnCompleteListener(new OnCompleteListener() {
                        ...
                        public void onComplete(@NonNull Task task)
                        {
                            ...
                            {
                                Toast.makeText(CommentsActivity.this,"คุณได้แสดงความคิดเห็นเรียบร้อย",Toast.LENGTH_SHORT).show();
                            }
                            else
                            {
                                Toast.makeText(CommentsActivity.this,"เกิดความผิดพลาด : กรุณาลองใหม่อีกครั้ง",Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
